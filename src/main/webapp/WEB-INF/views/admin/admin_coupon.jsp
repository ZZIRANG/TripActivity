        ...
        <div id="popmenu">
            ...
            <table class="table2">
            	...
            	<tr>
            		<td>발급 분류</td>
            		<td class="td">
            			<ul class="coupon_kind">
            				<li><input type="radio" name="coupon_kind issued2" value="할인권">할인권</li>
            				<li><input type="radio" name="coupon_kind issued2" value="숙박권">숙박권</li>
